...
=begin
    ...
    primary.item :devices_x, 'devices_x', "#{devices_path}/list" do |sub_nav|
      # Add an item to the sub navigation (same params again)
      sub_nav.item :devices_x_1, 'devices_x_1', "#{devices_path}/2"
      sub_nav.item :devices_x_2, 'devices_x_2', "#{devices_path}/3"
    end
=end
